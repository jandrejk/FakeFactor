...
basedir = "/ceph/jandrej/auto-fakefactors"
...
def jetFakeFactorPY():
    ...
    # fname1  = fname2
    fname1  = basedir+"/16_4_2017_FF_LQ_v1p1/et/inclusive/fakeFactors_tight.root" # fixed bug ff_w_mt no cap off >800 GeV
    fname2  = basedir+"/16_4_2017_FF_LQ_v1p2/et/inclusive/fakeFactors_tight.root" # fixed bug ff_w_mt with cap off >800 GeV
    print ">>> fname1:",fname1
    print ">>> fname2:",fname2
    ...
    # COMPARE SYSTEMATICS
    pt, dR, njets, mvis, pt_lep, mt, iso_lep = 60., 0.5, 0, 80., 50., 50., 0.1
