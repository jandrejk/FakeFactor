...
def jetFakeFactorPY():
    ...
    fname1  = basedir+"16_4_2017_FF_LQ_v1p1/mt/inclusive/fakeFactors_tight.root" # old
    fname2  = basedir+"16_4_2017_FF_LQ_v1p2/mt/inclusive/fakeFactors_tight.root" # new
