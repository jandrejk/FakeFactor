...
class FFCalculator : public GlobalClass, public PlotterClass{
 public:
  ...
  FFCalculator(//Int_t N_p_Wjets,Int_t N_p_DY,Int_t N_p_TT,Int_t N_p_QCD,Int_t N_p_QCD_AI,
               ...
               const Double_t pTratio_cuts_Wjets[],const Double_t pTratio_cuts_DY[],const Double_t pTratio_cuts_TT_SR[],const Double_t pTratio_cuts_TT_CR[],const Double_t pTratio_cuts_QCD[]
                  );
  ~FFCalculator();
