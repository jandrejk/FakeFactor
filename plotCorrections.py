...
if __name__ == '__main__':
     ...
     files_mt = [
              ...
              {'name': 'ViennaTool/fakefactor/data_mt/FF_corr_QCD_MCsum_noGen_OSSScorr.root','data':'OSSS_corr', 'graph':'OSSS_corr_QCD','CMS':preliminary,'Y':[0.2,2.1],'X':[0,1000], 'Label':'m_{vis} (GeV)','file':'corr_QCD_OSSS','plotLabel1':'#mu^{}#tau_{h} QCD multijet','plotLabel2':'opposite/same charge correction'},
              {'name': 'ViennaTool/fakefactor/data_mt/FF_corr_TT_MC_noGen_nonclosure.root','data':'nonclosure_fit', 'graph':'nonclosure_TT_MC','CMS':'Simulation '+preliminary,'Y':[0.5,1.5],'X':[0,1000], 'Label':'m_{vis} (GeV)','file':'corr_TT_nonclosure','plotLabel1':'#mu^{}#tau_{h} t#bar{t}','plotLabel2':'Nonclosure correction'},
              {'name': 'ViennaTool/fakefactor/data_mt/FF_corr_Wjets_MC_noGen_mtcorr.root','data':'mt_corr', 'graph':'mt_corr_Wjets','CMS':'Simulation '+preliminary,'Y':[0.5,1.5],'X':[0,1000], 'Label':'m_{vis} (GeV)','file':'corr_W_mt','plotLabel1':'#mu^{}#tau_{h} W+jets','plotLabel2':'DR-SR correction'},
              ...
              #{'name': 'ViennaTool/fakefactor/data_mt/FF_corr_TT_MC_noGen_nonclosure_alt.root','data':'nonclosure_fit', 'graph':'nonclosure_TT_MC','CMS':'Simulation','Y':[0.5,1.5],'X':[0,1000], 'Label':'m_{vis} (GeV)','file':'nonclosure_TT_alt'},
              #{'name': 'ViennaTool/fakefactor/data_mt/FF_corr_Wjets_MC_noGen_mtcorr_alt.root','data':'mt_corr', 'graph':'mt_corr_Wjets','CMS':'Simulation','Y':[0.4,2],'X':[0,1000], 'Label':'m_{T} (GeV)','file':'mtcorr_W_alt'},
     ...
     files_tt = [
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_nonclosure.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[0,1000], 'Label':'m_{vis} (GeV)','file':'corr_QCD_nonclosure','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'Nonclosure correction'},
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_OSSScorr.root','data':'OSSS_corr', 'graph':'OSSS_corr_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[0,1000], 'Label':'m_{vis} (GeV)','file':'corr_QCD_OSSS','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'opposite/same charge correction'},
     ...
     if(args.do_njetbinning == 1):
          files_tt.extend([
              ...
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_nonclosure_lepPt_0jet.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[40,1000], 'Label':'p_{T} (GeV)','file':'corr_QCD_nonclosure_pt_0jet','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'p_{T} correction, 0jet'},
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_nonclosure_lepPt_1jet.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[40,1000], 'Label':'p_{T} (GeV)','file':'corr_QCD_nonclosure_pt_1jet','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'p_{T} correction, #geq 1jet'},
              ])
     ...
     for el in files:
          ...
          infoRight = R.TLatex( 0.68, 0.915, "41.53 fb^{-1} (13 TeV)" )
          infoRight.SetNDC();
